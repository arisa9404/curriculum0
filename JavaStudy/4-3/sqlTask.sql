...
-- [回答]
SELECT 
store_table.store_name, goods_table.goods_name, stock_table.price
FROM
stock_table
JOIN
goods_table
...
-- [回答]
SELECT store_code, price FROM stock_table
WHERE price > (SELECT AVG(price) FROM stock_table WHERE store_code = 'EA01')
...
VALUES('M001', 'マフラー', 4500,'2021-06-26');
